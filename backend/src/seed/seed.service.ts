...
export class SeedService {
  ...
  async run(): Promise<number> {
    ...
    const products = [
      { title: 'Sukuma Wiki (Kale)', price: 45, quantity: 200, category: 'Vegetables', description: 'Freshly harvested sukuma wiki. Picked this morning, no chemicals.', imageUrl: 'https://images.unsplash.com/photo-1524179091875-bf99a9a6af97?auto=format&fit=crop&w=800&q=80', location: { lat: -1.171, lng: 36.835, address: 'Kiambu Road' } },
      ...
      { title: 'Grade A Milk (Raw)', price: 65, quantity: 100, category: 'Dairy', description: 'Pure fresh milk from healthy local cows. Clean and quality assured.', imageUrl: 'https://images.unsplash.com/photo-1550583724-1255818c0533?auto=format&fit=crop&w=800&q=80', location: { lat: -1.233, lng: 36.910, address: 'Githurai' } },
      ...
      { title: 'Onions (Red)', price: 130, quantity: 150, category: 'Vegetables', description: 'Red onions fresh from our farm. Strong flavor, long shelf life.', imageUrl: 'https://images.unsplash.com/photo-1508747703722-5c8e6c2b4c19?auto=format&fit=crop&w=800&q=80', location: { lat: -1.258, lng: 36.858, address: 'Mathare' } },
