...
**KilimoLink Direct is Nairobi's climate-smart food transport intelligence platform.**  
The marketplace matches supply to demand. The data becomes Nairobi's food-flow and logistics intelligence.
...
- She must plan for food access, climate disruption, transport routes, waste, and price shocks.
- Today she has no real-time data on where food comes from, which routes carry it, which neighborhoods need supply, or where climate will break the chain.

**Visual:** Food resilience officer + Nairobi food transport routes map with supply/demand zone gaps.
...
- Nairobi's food supply depends on truck routes from Kiambu, Machakos, Kajiado.
- Every kilometer adds emissions. Every empty return trip is wasted fuel. Every middleman adds cost and waste.
...
**Visual:** Farmer listing → buyer order → transport route optimization → county dashboard data stream.
...
- CO₂e and food waste impact tiles with per-route emissions estimates.

**Visual:** Dashboard mock/prototype with transport flow map, heatmap, alert cards, emissions tile.
...
1. **Supply disruption predictor:** forecasts crop shortages by transport corridor and neighborhood.
...
|---|---|---|
| Twiga Foods | B2B distribution | City climate intelligence + food transport flow data |
| DigiFarm | Farmer services | Nairobi market access + supply-demand zone matching |
| M-Farm | Price information | Live transactions + route-based predictive alerts |
| Generic marketplace | Connects buyers and sellers | Marketplace-as-data-engine for climate-smart food logistics |

**Key line:** Competitors move food. KilimoLink helps Nairobi understand, predict, route, and climate-proof its food system.
...
- Week 3–4: Ship county dashboard: transport flow map, heatmap, alert cards, impact tiles.
- Week 5–6: Add AI disruption, anomaly, carbon engines, and route risk maps.
- Week 7: Pilot supply-demand zone matching with farmers and buyers around Kibera/Mathare/Mukuru.
